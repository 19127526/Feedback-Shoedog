...
import InvoiceDrawer from '@/components/drawer/index.jsx'
                    ...
                    <div className="flex flex-col items-center  px-6 bg-feedback_color my-10">
                        <div className="max-w-2xl w-full">
                            ...
                            <form className="space-y-6" onSubmit={handleSubmitFeedback}>
                                ...
                                >
                                    <label className="block text-sm font-medium mb-1" htmlFor="message">Lời đánh
                                        giá</label>
                        ...
                        <ButtonDetailComponent icon={<PicRightOutlined />} onClick={handleOnClickDrawer} />
                    </div>
                    <InvoiceDrawer open={openDetail} onClose={() => setOpenDetail(false)} data={billInfo?.note}/>
                </Fragment>
            )
            :
